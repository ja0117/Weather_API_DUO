...
(function() {
    ...
    EXAMPLES.descriptions = {
        ...
        'vector-map-style-altering.html': '<p>This advanced example allows changing the style of the presented map ' +
            ...
            '</li><li><a target="_blank" href="https://developer.tomtom.com/online-maps/online-maps-documentation-vector/tile">TomTom ' +
            'vector data format</a></li></ul></p>',
        'heatmap.html':  '<p>This example is showing distribution of data using heatmaps. ' +
        'Data was gathered using <a href="https://developer.tomtom.com/online-search/online-search-documentation" target="_blank">' +
        'Tomtom Search API</a> to get nearby POI\'s. In order to create a heatmap layer <a href="https://github.com/Leaflet/Leaflet.heat" target="_blank">' +
        ...
        'routing-alternatives-with-deviation.html': '<p>This example demonstrates the usage of <a href="https://developer.tomtom.com/maps-sdk/maps-sdk-documentation#Routing" ' +
            'target="_blank"><i>Alternative routes</i></a>, <a href="https://developer.tomtom.com/online-routing/online-routing-documentation-routing/calculate-route" ' +
        ...
        'truck-size-weight.html': 'This example demonstrates the usage of Vehicle parameters for route calculation. ' +
            'For more information on these paramenters please refer to the ' +
            '<a target="_blank" href="https://developer.tomtom.com/online-routing/online-routing-documentation-r' +
            'outing/common-routing-parameters">Common Routing Parameters Documentation</a> and <a target="_blank" ' +
            'href="https://developer.tomtom.com/maps-sdk/maps-sdk-documentation#Routing">' +
            'Maps Web SDK Documentation</a>.</p><p>This example does not use traffic information to calculate routes.</p>',
        'heading.html': 'This example shows you how to use the \'vehicleHeading\' parameter. For more information please ' +
            'refer to the <a target="_blank" href="https://developer.tomtom.com/maps-sdk/maps-sdk-documentation#Routing">' +
        ...
        'search-with-autocomplete.html': '<p>A presentation of the ' +
            ...
            '<a href="https://developer.tomtom.com/maps-sdk/maps-sdk-documentation#L.MarkersLayer" target="_blank">' +
        ...
        'polygons-for-search-results.html': '<p>This example shows how to use Additional Data service to ' +
            'retrieve polygons representing borders of a particular search result. Polygons are available for ' +
            'Geographies and some POIs.</p><p>For more information please refer to the ' +
            '<a href="https://developer.tomtom.com/online-search/online-search-documentation/additional-data" target="_blank">' +
    ...
    EXAMPLES.load = function(exampleId) {
        ...
        CodepenLinkGenerator.prototype.getJavascriptCodeForCodepen = function(code, keys) {
            var generatedCode = code
                ...
                .replace(/<your-product-version>/g, '4.36.5-SNAPSHOT')
                .replace(/<your-product-name>/g, 'Codepen Examples')
                .replace(/<your-tomtom-sdk-base-path>/g, 'https://api.tomtom.com/maps-sdk-js/4.35.6/examples/sdk');

            if (generatedCode.match(/^\s*require\(\[.*/g)) {
                var requireConfig = {
                    baseUrl: 'https://api.tomtom.com/maps-sdk-js/4.35.6/examples'
                };
        ...
        function parseCode(response) {
            ...
            displayReponse = response.replace(/${api.key}/g, '<your-tomtom-API-key>')
                ...
                .replace(/4.36.5-SNAPSHOT/g, '<your-product-version>')
